...
public class Zadatak3 {
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            driver.findElement(By.name("departmen")).sendKeys("Geografija");
            driver.findElement(By.name("phone")).sendKeys("+3819887766");
            driver.findElement(By.xpath("//body/tr[]last()]/a[]@class='add']")).click();
            Thread.sleep(500);
