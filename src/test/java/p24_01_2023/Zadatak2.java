...
//Klikce na dugme Login. Xpath ovog elementa treba da bude tako da se
// prvo dohvati form element i da se od njega spusti do dugmeta

        driver.findElement(By.xpath("//form[@id='userForm']/div[4]/div/button[@id='login']")).click();
        Thread.sleep(5000);
